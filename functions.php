...
function beverage_scripts() {
	/*css*/
	wp_enqueue_style( 'beverage-libs-styles', get_template_directory_uri() . '/css/libs.min.css' );
	wp_enqueue_style( 'beverage-style', get_template_directory_uri() . '/css/styles.min.css' );
	/*js*/
	wp_enqueue_script( 'beverage-jquary', get_template_directory_uri() . '/js/jquery-2.1.3.min.js', array(), '', true );
	wp_enqueue_script( 'beverage-owl-carousel', get_template_directory_uri() . '/js/owl.carousel.min.js', array(), '', true );
	wp_enqueue_script( 'beverage-script', get_template_directory_uri() . '/js/script.min.js', array(), '', true );
}
